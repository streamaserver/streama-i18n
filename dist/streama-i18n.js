...
angular.module('streama.translations').config(['$translateProvider', function ($translateProvider) {
	$translateProvider.translations('de', {
		...
		DASHBOARD: {
			...
			NEWEST_SHOWS: 'Neue Folgen',
			NEWEST_MOVIES: 'Neue Filme',
			NEWEST_ADDED_SHOWS: 'Neu hinzugefügte TV-Shows',
			NEWEST_ADDED_MOVIES: 'Neu hinzugefügte Filme',
...
angular.module('streama.translations').config(['$translateProvider', function ($translateProvider) {
	$translateProvider.translations('en', {
		...
		DASHBOARD: {
			...
			NEWEST_SHOWS: 'Newest Show Releases',
			NEWEST_MOVIES: 'Newest Movies',
			NEWEST_ADDED_SHOWS: 'Recently added Shows',
			NEWEST_ADDED_MOVIES: 'Recently added Movies',
